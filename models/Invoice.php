...
namespace pantera\yii2\pay\alfabank\models;
...
class Invoice extends ActiveRecord
{
     ...
     * @return self
     */
    public static function addAlfabank($orderId = null, $price, $remoteId = null, $data = [])
    {
     ...
     * передается в API Альфабанка параметром uniqid
     */
