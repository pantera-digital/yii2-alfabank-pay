...
namespace pantera\yii2\pay\alfabank\controllers;
...
class DefaultController extends Controller
{
    ...
    public function actionComplete()
    {
        ...
        $result = $this->module->alfabank->complete(Yii::$app->request->get('orderId'));
    ...
    /**
     * Создание оплаты редеректим в шлюз альфабанка
     * @param $id
    ...
    public function actionCreate($id)
    {
        ...
        $result = $this->module->alfabank->create($model);
